...
<html lang = "en-US">
<head>
<title>On the waterfront: Pros & cons</title>
...
<body>
    <article>
    <h1>On the waterfront: Pros & cons</h1>
        <div class="wrapper">
        ...
        <div>
            ...
            <div class="richText"> 
            <p style="text-align: center;"><img class="aligncenter" src="https://dih4lvql8rjzt.cloudfront.net/cms/ae3a8c69-a81f-4c62-9563-5eeecbb42223_waterfronthome.jpg" width="700"></p>
        ...
        <p><strong>Aquatic advantages </strong></p>
        ...
        <p><strong>Harborside headaches </strong></p>
...
let val = htmlDocument.TESTs(contents);
